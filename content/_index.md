...
{{< finds >}}
{{< find page="/playground/building-tenor-ukulele" >}}Built with two professional violin makers looking over my shoulder.{{< /find >}}
...
What ends up in the chest is not books. It is methods, experience, techniques, mistakes, and the mental models that tie them together.

Nothing stays in its own drawer. The question behind my PhD, how precise a measurement has to be before you can trust it, first came up in brain tractography and in measuring a pulse from video. It came back at a clay printer, where I ended up doing a drop test to calibrate the material. And a motion sensor in a mentoring project for two thirteen-year-olds turned into a conversation about thermal cameras, which is where my own work lives. The fuller the chest, the more often two things meet that do not belong to the same field. That is what I am good at, and it is why I keep filling it.
